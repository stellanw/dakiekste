...
const StyledScrollBoxWrapper = styled.div`
  ...
  /* Desktop: echte Scroll-Area mit versteckter Scrollbar */
  display: flex;
  overflow-x: scroll;
  cursor: grab;
  ...
  /* Mobil: native Swipe + Snap + sichtbare Scrollbar */
  &[data-touch="1"] {
    cursor: default;
    overflow-x: auto;
    ...
    scrollbar-color: ${theme.color.beige} transparent;
...
const StyledScrollBox = styled.div`
  ...
  align-items: start;
  color: ${theme.color.beige};
  padding: 0 var(--spacing-xl) var(--spacing-s) 0;
  min-width: 600px;
  flex: 0 0 1;
